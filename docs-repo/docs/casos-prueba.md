...
En mi portafolio, los casos de prueba conectan la intención de negocio con la validación técnica y funcional del sistema. No reemplazan el **Caso de Uso**, la **Historia de Usuario** ni los **Criterios de Aceptación**; los aterrizan en verificaciones ejecutables.
...
## 🧭 Uso dentro del flujo mi portafolio
...
Para el flujo completo de ramas, PRs, QA, UAT y ambientes, consulta **[GitHub Flow del portafolio](../procesos/github-flow.html)**.
