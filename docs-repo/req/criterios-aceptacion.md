...
En **mi portafolio** utilizamos principalmente dos formatos para redactar criterios de aceptación, dependiendo de la naturaleza de la tarea:
...
| **Interfaz** | Los colores deben verse profesionales. | La paleta de colores debe seguir el sistema de diseño de mi portafolio (Color primario: HSL 220, 90%, 56%). El contraste del texto debe pasar la accesibilidad WCAG AA. |
