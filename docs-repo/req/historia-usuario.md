...
nav_order: 3
permalink: /req/historia-usuario.html
---
...
En mi portafolio, una HU debe nacer preferiblemente de un **Caso de Uso (CU)** o de una regla de negocio validada. El CU explica el flujo completo; la HU convierte una parte implementable de ese flujo en trabajo listo para desarrollo.
...
Los casos de prueba se documentan en la guía técnica **[Casos de Prueba](../docs/casos-prueba.html)**. El avance operativo de la HU se rige por el **[GitHub Flow del portafolio](../procesos/github-flow.html)**.
...
Para el detalle de ramas, PRs, CI, aprobaciones y entrega, consulta el **[GitHub Flow del portafolio](../procesos/github-flow.html)**.
