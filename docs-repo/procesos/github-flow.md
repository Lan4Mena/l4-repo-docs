---
layout: default
title: GitHub Flow mi portafolio
parent: Procesos
nav_order: 1
permalink: /procesos/github-flow.html
---

# 🔄 GitHub Flow mi portafolio
...
En mi portafolio utilizamos **GitHub Flow**:
...
flowchart TD
    ...
    UseCaseDecision -->|"Si"| ExistingUseCase["Actualizar Caso de Uso"]
    UseCaseDecision -->|"No"| NewUseCase["Crear Caso de Uso"]
    ExistingUseCase --> Backlog["HU Backlog"]
    NewUseCase --> Backlog
    Backlog --> Refining["Refinamiento"]
    Refining --> Ready["HU Ready"]
...
mi portafolio usa plantillas independientes por tipo de repositorio en `.github/PULL_REQUEST_TEMPLATE/`:
...
*   **[¿Cómo Documentar?](../como-documentar.html):** Estándar Docs-as-Code para documentación técnica y funcional.
